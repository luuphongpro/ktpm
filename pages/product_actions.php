...
function showQuickViewButton($productId): string {
    return '<a href="index.php?detail_product&id=' . $productId . '" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Xem nhanh</a>';
}
