            ...
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold">
                        <span class="text-primary font-weight-bold border px-3 mr-1">B</span>Belleza
                    </h1>
                </a>
            </div>
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 205px">
                        <div class="nav-item dropdown">
                            ...
                            <!-- <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    ...
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">
                                            ...
                                            <ul>
                                                <li>Tẩy trang</li>
                                                <li>Dầu tẩy trang</li>
                                                <li>Nước tẩy trang</li>
                                                <li>Khăn ướt tẩy trang</li>
                                                <li>Sữa rửa mặt</li>
                                                <li>Gel rửa mặt</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Dưỡng Da</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Dưỡng ẩm</li>
                                                <li>Kem dưỡng & Sữa dưỡng</li>
                                                <li>Dầu dưỡng</li>
                                                <li>Gel dưỡng</li>
                                                <li>Xịt khoáng</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chống nắng</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Xịt chống nắng</li>
                                                <li>Sữa chống nắng</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Mặt nạ</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Mặt nạ giấy</li>
                                                <li>Mặt nạ đất sét</li>
                                                <li>Mặt nạ ngủ</li>
                                                <li>Mặt nạ rửa</li>
                                            </ul>
                                        </div>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chăm sóc chuyên sâu</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Miếng dán mụn</li>
                                                <li>Kem/Gel đặt trị mụn</li>
                                                <li>Nước cân bằng</li>
                                                <li>Serum dưỡng da</li>
                                                <li>Tinh chất/ Nước thần</li>
                                                <li>Chống lão hóa</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Set chăm sóc da</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Set chăm sóc da</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chăm sóc da khác</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Thực phẩm cho sắc đẹp</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chăm sóc môi</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">
                                            ...
                                            <ul>
                                                <li>Son Dưỡng</li>
                                                <li>Mặt nạ môi</li>
                                                <li>Tẩy tế bào chết môi</li>
                                                <li>Tinh chất dưỡng môi</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chăm sóc mắt</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Tinh chất dưỡng mắt</li>
                                                <li>Kem dưỡng vùng mắt</li>
                                                <li>Mặt nạ mắt</li>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <!-- <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chăm sóc cá nhân</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Dầu dưỡng thể</li>
                                                <li>Kem dưỡng Tay & Chân</li>
                                                <li>Sữa dưỡng thể</li>
                                                <li>Kem dưỡng thể</li>
                                                <li>Sản phẩm khử mùi</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Đặc trị cơ thể</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>
                                                <li>Trị mụn, thâm và sẹo</li>
                                                <li>Chống rạn và nhăn da</li>
                                                <li>Chăm sóc ngực</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Chống nắng cơ thể</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">

                                            <ul>

                                                <li>Kem chống nắng cơ thể</li>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <!-- <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    ...
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">
                                            ...
                                            <ul>
                                                ...
                                                <li>Kem nền</li>
                                                <li>Kem nền BB & CC</li>
                                                <li>Phấn phủ dạng nền</li>
                                                <li>Phấn phủ dạng nén</li>
                                                <li>Má hồng</li>
                                                <li>Tạo khối</li>
                                                <li>Kem che khuyết điểm</li>
                                                <li>Highlighter</li>
                                                <li>Kem lót</li>
                                                <li>Xịt giữ nền</li>
                                                <li>Bảng phấn nền</li>
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Môi</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">
                                ...
                                <li>
                                    <a href="" class="dropdown-item">Mắt</a>
                                    <div class="suboverlaymenu">
                                        <div class="list-menu">
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span
                                class="text-primary font-weight-bold border px-3 mr-1">B</span>Belleza</h1>
                    </a>
