class BasicHome{
    ...
    getAccount(){
        return JSON.parse(sessionStorage.getItem("currentLogin")) || {};
    }
    setAccount() {
        return sessionStorage.setItem('currentLogin',JSON.stringify(this.Account));
    }
    scrollTop(){
    ...
    eventSearch(){
        $('.button_search').click(function() {
            $('#search_product_top').submit()
        })
    }
}
class Home extends BasicHome{
    constructor() {
        super();
    }
}
